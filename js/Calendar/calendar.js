...
// $Id: calendar.js,v 1.1 2004/08/20 14:37:34 krasi Exp $
...
Calendar.is_ie7 = ( Calendar.is_ie && /msie [789]\.0/i.test(navigator.userAgent) );
...
Calendar.prototype.showAtElement = function (el, opts) {
	...
	function fixPosition(box) {
		...
		if (Calendar.is_ie) {
			br.y += Calendar.is_ie7 ? document.getElementsByTagName('html')[0].scrollTop : document.body.scrollTop;
			//br.y += document.getElementsByTagName('html')[0].scrollTop;
...
Calendar.prototype.hideShowCovered = function () {
	...
	Calendar.continuation_for_the_fucking_khtml_browser = function() {
		function getVisib(obj){
			...
			value = obj.style.display=='none'? 'hidden' : 'visible';
			if (!value) {
				if (document.defaultView && typeof (document.defaultView.getComputedStyle) == "function") { // Gecko, W3C
					if (!Calendar.is_khtml)
						value = document.defaultView.getComputedStyle(obj, "").getPropertyValue("display")==='none' ? 'hidden' : 'visible';
					else
						value = '';
