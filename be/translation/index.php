...
if($__mvc) {
	...
	$filter_session_name="filter_translation";
}
else  {
	...
	if(isset($in_edit_id)&&(int)$in_edit_id) {
		...
		$filter_session_name="filter_translation";
		$search=gettranslationControls('search');
	}
}


$__del_var="hdDeletetranslation";
$__editTable="translation";
$fn_Delete="";/*
$fn_Delete="del_translation";

function del_translation($del_id) {
	$db=getdb();
		
	$db->execute("delete from `translation` where id='{$del_id}'");
}*/
