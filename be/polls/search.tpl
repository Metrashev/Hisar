...
<tbody>
	...
	<td><ITTI field_name="keywords" style="width:90%"></ITTI> </td>
	</tr>
	<tr>
		<td colspan="2" align="center" style="padding-right:10px;">
							<input type="submit" class="submit" name="search" value="Search" />&nbsp;&nbsp;&nbsp;<input class="submit" type="submit" name='btClear' value="Clear" />
	</td></tr>
</tbody></table>