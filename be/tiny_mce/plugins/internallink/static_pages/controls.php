...
class CStPage {
	...
	function getLink($params) {
		...
		$spid=!(int)($row['spid'])?"":"&amp;spid=".$row['spid'];
...
if(!function_exists("getControls")) {
	...
	'categories'=>array(
		...
		'control'=>array("Label"=>"categories","name"=>"in_data[categories]","isHTML"=>false,"tagName"=>"Select","bound_field"=>"categories","userFunc"=>"","FormatString"=>"",'autoload'=>array("type"=>"sql",'value'=>array("DataSource"=>"select id,value from categories where level>0 order by l",'addzero'=>array('key'=>0,'value'=>'')))),
