...
<script language="javascript" type="text/javascript">
	...
	tinyMCE.init({
		...
		extended_valid_elements : "iframe[*],a[name|href|target|title|onclick],map[*],area[shape|coords|href|title|target],object[*],param[*],embed[*],ittiscript[*],input[*],script[*],div[*]",
